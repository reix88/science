...
<div class="form-row form-col">
  <div class="col col1">
    <p>Dec-></p>
    <textarea class="form-control" id="text1" rows="5" name="dec"></textarea>
  </div>
...
<center>
  ...
  <a class="btn btn-secondary btn-margin btn-lg" href="<?php echo BNR; ?>" role="button"><img src="../img/arrows.png" width="26"></a>
</center>

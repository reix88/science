...
<div class="form-row form-col">
  ...
  <div class="col col2">
    <p>->Текст</p>
    <textarea class="form-control" id="text2" rows="5" name="text"></textarea>
  </div>    
</div>

<center>
  <input class="btn btn-primary btn-lg btn-margin" type="submit" value="Декодировать" id="enter">
  <a class="btn btn-secondary btn-margin btn-lg" href="<?php echo BC; ?>" role="button"><img src="../img/arrows.png" width="26"></a>
</center>

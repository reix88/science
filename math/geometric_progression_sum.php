...
<head>
  ...
  <title>Геометрическая прогрессия (Сумма)| Математика</title>
  <meta name="description" content="Геометрическая прогрессия онлайн, просто и быстро!">
  <meta name="keywords" content="геометрическая прогрессия онлайн, геометрическая прогрессия, сумма">
...
<h6 style="color: #007BFF;">Геометрическая прогрессия имеет вид:</h6>
  ...
  <div class="buttons-link">
    ...
    <a href="<?php echo GPC; ?>" class="btn btn-outline-info btn-lg btn-block">Найти произведение первых n членов прогрессии</a>
  </div>
